"""Enrollment endpoint — thin async handler, delegates to service."""
...
async def enrollment_by_college(
    term: Annotated[
        str | None,
    ...
    return await svc.by_college(term=term, classifications=classification)
